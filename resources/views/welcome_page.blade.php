...
<head>
    ...
    <meta name="description" content="SCOPS — Smart Control of Paid Systems"/>
    ...
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=Manrope:wght@400;500;600;700&display=swap"/>
    <link rel="preload" as="image" href="{{ asset('asset/owl_cyan.png') }}"/>
    <link rel="preload" as="image" href="{{ asset('asset/scops_wordmark.png') }}"/>
    <style>
        :root {
            --navy:        #050B16;
            --navy-2:      #08111F;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-cta:hover {
            ...
            box-shadow: 0 0 0 1px rgba(20,230,244,0.6), 0 12px 34px rgba(20,230,244,0.4);
        }
        ...
        .eyebrow .dot {
            ...
            animation: pulse 2.4s ease-in-out infinite both;
        }
        ...
        .btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 16px 40px -6px rgba(255,107,0,0.6), inset 0 1px 0 rgba(255,255,255,0.25);
        }
        ...
        .visual .halo {
            ...
            filter: blur(10px);
            animation: breathe 7s ease-in-out infinite both;
        }
        ...
        .ring.spin::after {
            ...
            border-radius: 50%;
            background: var(--cyan);
            box-shadow: 0 0 12px 2px rgba(20,230,244,0.9);
        ...
        .chip {
            ...
            animation: float 6.5s ease-in-out infinite both;
        }
        .chip .av {
...
<div class="shell" data-screen-label="SCOPS Start Page">
    ...
    <header class="reveal d1">
        <div class="brand">
            <img class="mark" src="{{asset('asset/owl_cyan.png')}}" width="38" height="38" loading="eager" />
            <img class="wordmark" src="{{asset('asset/scops_wordmark.png')}}" width="120" height="40" loading="eager" />
        </div>
        <nav class="top">
    ...
    <main>
        <section class="card reveal d2">
            ...
            <p class="lede">SCOPS brings all your recurring payments into one place — track spending, get renewal
                reminders before you're charged, and manage every linked card with confidence.</p>

            <div class="features" id="features">
                <div class="feature">
                    <span class="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                           stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path
                                d="M7 14l4-4 3 3 5-6"/></svg></span>
                    Track recurring payments
                </div>
                <div class="feature">
                    <span class="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                           stroke-linecap="round" stroke-linejoin="round"><path
                                d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path
                                d="M13.7 21a2 2 0 0 1-3.4 0"/></svg></span>
                    Timely renewal reminders
                </div>
                <div class="feature">
                    <span class="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                           stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="20"
                                                                                                height="14" rx="2"/><path
                                d="M2 10h20"/></svg></span>
                    Manage linked cards
                </div>
                <div class="feature">
                    <span class="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                           stroke-linecap="round" stroke-linejoin="round"><path
                                d="M21 21H4a1 1 0 0 1-1-1V3"/><rect x="7" y="11" width="3" height="6"/><rect x="13"
                                                                                                             y="7"
                                                                                                             width="3"
                                                                                                             height="10"/></svg></span>
        ...
        <section class="visual reveal d3" aria-hidden="true">
            ...
            <img class="owl" src="{{asset('asset/owl_cyan.png')}}" alt="" loading="eager" fetchpriority="high" width="230" height="230"/>

            <div class="chip c1">
                <span class="av"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor"
                                      stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path
                            d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path
                            d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></span>
            ...
            <div class="chip c3">
                <span class="av"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor"
                                      stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path
                            d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="M22 4L12 14.01l-3-3"/></svg></span>
